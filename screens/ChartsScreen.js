...
const ChartsScreen = () => {
  const [image_uri, setImage] = useState(
    'https://cdn.pose.com.vn/assets/2019/03/14/rv.bae_.irene_49539738_2007696232861865_4554756812831883696_n.jpg',
  );
    ...
    <View style={styles.container}>
      ...
      <View style={styles.desBox}>
        <Text style={styles.description}>
          Top 15 được thăng lên giải đấu cao hơn
        </Text>
      </View>
        ...
        <FlatList
          ...
          renderItem={({item}) => (
            <ListItem
              ...
              leftAvatar={{source: {uri: image_uri}}}
