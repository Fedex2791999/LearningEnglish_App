...
class NewWord4 extends Component {
    constructor() {
        super();
                ...
                <View style={{
                    ...
                    <View style={{ flex: 1, flexDirection: 'row' }}>
                        <View style={{ flex: 1, alignItems: 'center' }}>
                            <Image style={styles.logo} source={require('../../../assets/images/basketball.png')} ></Image>
                            <TextInput style={{marginTop: 10}} placeholder="________" 
                            onChangeText={(text) => { this.setState({ Value1: text }) }}></TextInput>
                        </View>
                        <View style={{ flex: 1, alignItems: 'center'}}>
                            <Image style={styles.logo} source={require('../../../assets/images/football.png')} ></Image>
                            <TextInput style={{marginTop: 10}} placeholder="________"
                    ...
                    <View style={{ flex: 1, flexDirection: 'row' }}>
                        <View style={{ flex: 1, alignItems: 'center'}}>
                            <Image style={styles.logo} source={require('../../../assets/images/swimming.png')} ></Image>
                            <TextInput style={{marginTop: 10}} placeholder="________"
                            onChangeText={(text) => { this.setState({ Value3: text }) }}></TextInput>
                        </View>
                        <View style={{ flex: 1, alignItems: 'center'}} >
                            <Image style={styles.logo} source={require('../../../assets/images/volleyball.png')} ></Image>
                            <TextInput style={{marginTop: 10}} placeholder="________"
